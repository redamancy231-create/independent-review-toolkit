...
> ⚡ 复制 prompt → 粘贴到新 AI 会话 → 替换[材料] → 5分钟启动第一次独立审查 | 50+轮 · 5种后端 · 4步流程
...
| [**Methodology Handbook**](https://github.com/redamancy231-create/methodology-handbook) | **同级项目**——50 条 AI 协作实战教训速查手册；多模型审查、provenance、认知偏差等条目为本工具包的设计原则提供了经验来源 |
